package codewars.level_7kyu.arrays
...
fun outed(meet: Map<String, Int>, boss: String) =
    if ((meet.values.sum() + meet[boss]!!) / meet.keys.count() <= 5) "Get Out Now!"
    else "Nice Work Champ!"

//----------------------------------------------------------------------------------------------------------------------
fun outed1(meet: Map<String, Int>, boss: String) =
    if ((meet.values + meet[boss]!!).average() <= 5) "Get Out Now!"
    else "Nice Work Champ!"
//----------------------------------------------------------------------------------------------------------------------
