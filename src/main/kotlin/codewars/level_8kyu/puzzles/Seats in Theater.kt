package codewars.level_8kyu.puzzles
...
private fun main() {
    println("96 = ${seatsInTheater(16,11,5,3)}")
    println("0 = ${seatsInTheater(1,1,1,1)}")
    println("18 = ${seatsInTheater(13,6,8,3)}")
}

//----------------------------------------------------------------------------------------------------------------------
private fun seatsInTheater(nCols: Int, nRows: Int, col: Int, row: Int) = (nCols - col + 1) * (nRows - row)
